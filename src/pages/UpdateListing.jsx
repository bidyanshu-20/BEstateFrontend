...
const UpdateListing = () => {
  ...
  useEffect(() => {
    const fetchListing = async () => {
      try {
        ...
        const res = await fetch(`https://bestatebackend.onrender.com/api/listing/get/${listingId}`);
        const data = await res.json();
        if (!data) {
          console.log("ERROR HAS OCCURRED IN FETCHING DATA....");
          return;
        }
        // console.log("List data is from updatepage : ", data);
  ...
  const updateHandler = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`https://bestatebackend.onrender.com/api/listing/update/${params.listingId}`, {
        method: "PUT",
        credentials: "include",
        headers: {
  ...
  return (
    <main className="min-h-screen p-6 flex items-center justify-center text-white">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://images.unsplash.com/photo-1495476479092-6ece1898a101?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NDl8fHVwZGF0ZSUyMGJhY2tncm91bmQlMjBwYWdlfGVufDB8fDB8fHww'), linear-gradient(to bottom right, rgba(255,255,255,0.9), rgba(245,245,245,0.9))",
        }}
      >
        <h1 className="text-3xl font-bold text-center mt-2 tracking-wide drop-shadow-md">
          Update Listing
        </h1>
        ...
        >
          ...
          <div className="flex flex-col gap-4 flex-1">
            <input
              ...
              placeholder="Name"
              id="name"
              className="border border-gray-300 p-3 rounded-lg outline-none focus:ring-2  focus:ring-orange-500 transition"
              maxLength={60}
              minLength={10}
              required
            ...
            <textarea
              ...
              id="description"
              className="border border-gray-300 p-3 rounded-lg outline-none focus:ring-2  focus:ring-orange-500 transition resize-none"
              rows={4}
              required
              onChange={handleChange}
            ...
            <div className="flex flex-wrap gap-6 mt-2">
              <div className="flex items-center gap-2">
                ...
                />
                <span className="text-sm ">Bed-Rooms</span>
              </div>
              <div className="flex items-center gap-2">
                <input
                  onChange={handleChange}
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  max="100000"
                  required
                  className="p-2 border border-gray-300 outline-none rounded-lg w-24 focus:ring-2  transition"
                />
